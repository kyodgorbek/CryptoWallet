...
android {
    namespace = "com.master.myapplication"
    ...
    // ✅ Java 17 (required for web3j 5.x)
    compileOptions {
    ...
    // ✅ FIX: Netty / Vertx / Web3j META-INF conflicts
    packaging {
        resources {
            excludes += listOf(
                // Netty / Vertx / Web3j
                ...
                // Jackson FastDoubleParser (ALL variants, forever)
